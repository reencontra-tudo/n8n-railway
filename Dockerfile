...
# Instalar nginx e supervisor (Debian/Ubuntu usa apt-get)
...
RUN cat > /etc/supervisor/conf.d/n8n.conf << 'SUPERVISOR_CONF'
[supervisord]
nodaemon=true
...
# N8N_SECURE_COOKIE=true + SameSite=lax necessário para Chrome moderno
